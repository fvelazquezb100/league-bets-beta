-- Update the update_combo_bet_status function to award total payout instead of net profit
...
BEGIN
  ...
  ELSIF v_won_count = v_total_selections THEN
    ...
    -- Add points to user for winning combo bet (changed from net profit to total payout)
    PERFORM public.update_league_points(v_bet.user_id, v_calculated_payout);
