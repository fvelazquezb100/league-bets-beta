          ...
          <CardContent>
            {loadingWeek ? (
              ...
              <div className="text-sm" style={{ lineHeight: 1.5 }}>
                <p>
                  <span className="font-semibold mb-3">Nombre:</span> {leagueData.name} ({leagueData.type})
                </p>
                ...
                <p>
                  <span className="font-semibold mb-3">Presupuesto:</span> {leagueData.budget} ({leagueData.reset_budget})
                </p>
                <p>
                  <span className="font-semibold mb-3">Apuesta mínima:</span> {leagueData.min_bet}
                </p>
                <p>
                  <span className="font-semibold mb-3">Apuesta máxima:</span> {leagueData.max_bet}
                </p>
                <p>
                  <span className="font-semibold mb-3">Semana de la liga:</span> {leagueData.week}
                </p>
              </div>
            ) : (
