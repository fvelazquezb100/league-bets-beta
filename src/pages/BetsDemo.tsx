      ...
      <nav className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-16 z-50">
        <div className="container mx-auto px-4">
          <div className="flex space-x-8">
            ...
            <div 
              className="flex items-center py-4 px-2 text-sm font-medium border-b-2 border-transparent text-muted-foreground hover:text-foreground"
              id="historial-nav-button"
            >
              Historial
            </div>
          </div>
        ...
        <div className="w-full px-2 sm:container sm:mx-auto sm:p-4">
          ...
          {!isMobile ? (
            ...
            <TabsContent value="champions" className="mt-0">
              ...
              <div className="w-full md:w-1/3 md:sticky md:top-32 md:self-start z-40" id="bet-slip">
                <BetSlipDemo 
