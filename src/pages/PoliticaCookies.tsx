...
export default function PoliticaCookies() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <h1 className="text-2xl md:text-3xl font-bold mb-2 text-foreground">Política de Cookies</h1>

      {/* 1. ¿Qué son las cookies? */}
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">1. ¿Qué son las cookies?</h2>
      ...
      <h2 className="text-xl font-semibold mt-2 mb-3 text-foreground">2. ¿Cómo gestionamos el consentimiento?</h2>
      <p className="text-sm md:text-base text-muted-foreground">
      ...
      <h2 className="text-xl font-semibold mt-2 mb-3 text-foreground">3. Finalidades y opciones disponibles</h2>
      <p className="text-sm md:text-base text-muted-foreground">
      ...
      <h2 className="text-xl font-semibold mt-2 mb-3 text-foreground">4. Gestión de tus preferencias</h2>
      <p className="text-sm md:text-base text-muted-foreground">
      ...
      <ul className="list-disc pl-6 text-sm md:text-base text-muted-foreground space-y-1">
        <li>
          <a href="https://support.google.com/chrome/answer/95647?hl=es" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#FFC72C] transition-colors">
            Google Chrome: eliminar, permitir y gestionar cookies
          </a>
        </li>
        <li>
          <a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#FFC72C] transition-colors">
            Mozilla Firefox: habilitar y deshabilitar cookies
          </a>
        </li>
        <li>
          <a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#FFC72C] transition-colors">
            Safari (macOS): gestionar cookies en Safari
          </a>
        </li>
        <li>
          <a href="https://support.microsoft.com/es-es/microsoft-edge/eliminar-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#FFC72C] transition-colors">
      ...
      {/* 4. Consentimiento */}
      <h2 className="text-xl font-semibold mt-2 mb-3 text-foreground">5. Base legal y responsabilidades</h2>
      <p className="text-sm md:text-base text-muted-foreground">
      ...
      <h2 className="text-xl font-semibold mt-2 mb-3 text-foreground">6. Actualización de esta Política</h2>
