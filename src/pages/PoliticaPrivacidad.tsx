...
export default function PoliticaPrivacidad() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <h1 className="text-2xl md:text-3xl font-bold mb-2 text-foreground">Política de Privacidad</h1>
      ...
      <section className="space-y-4">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">2. Datos personales que recopilamos</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">4. Base legal del tratamiento</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">6. Comunicación de datos a terceros</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">7. Transferencias internacionales</h2>
          <p className="text-sm md:text-base text-muted-foreground">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">8. Derechos del usuario</h2>
          ...
          <p className="text-sm md:text-base text-muted-foreground mt-2">
            Para ejercerlos, escribe a <a href="mailto:contact@jambol.co" className="underline hover:text-[#FFC72C] transition-colors">contact@jambol.co</a> indicando "Derechos RGPD" en el asunto. También puedes presentar una reclamación ante la Agencia Española de Protección de Datos (AEPD) si consideras que no hemos atendido correctamente tu solicitud.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">9. Seguridad de los datos</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">10. Uso de cookies</h2>
          <p className="text-sm md:text-base text-muted-foreground">
            Utilizamos cookies propias y de terceros (Google Analytics y redes publicitarias) para analizar el tráfico, personalizar la experiencia y mostrar anuncios relevantes. Puedes gestionar o revocar tu consentimiento en cualquier momento desde el banner de cookies o visitando nuestra <Link to="/politica-cookies" className="underline hover:text-[#FFC72C] transition-colors">Política de Cookies</Link>.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">11. Enlaces a sitios de terceros</h2>
          <p className="text-sm md:text-base text-muted-foreground">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">12. Modificaciones de esta política</h2>
          <p className="text-sm md:text-base text-muted-foreground">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-foreground">Contacto</h2>
          <p className="text-sm md:text-base text-muted-foreground">
            Si tienes dudas sobre esta política o sobre el uso de tus datos personales, puedes escribirnos a <a href="mailto:contact@jambol.co" className="underline hover:text-[#FFC72C] transition-colors">contact@jambol.co</a>.
          </p>
        </div>
      </section>
