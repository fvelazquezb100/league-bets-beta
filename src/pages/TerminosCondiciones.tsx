...
export default function TerminosCondiciones() {
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <h1 className="text-2xl md:text-3xl font-bold mb-2 text-foreground">Términos y Condiciones</h1>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">1. Naturaleza del servicio</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">2. Registro y cuenta de usuario</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">3. Reglas de juego y funcionamiento</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">4. Conducta y uso del servicio</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">5. Disponibilidad y mantenimiento</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">6. Privacidad y tratamiento de datos</h2>
      <p className="text-sm md:text-base text-muted-foreground">La gestión de datos personales se realiza conforme a nuestra Política de Privacidad. Los usuarios pueden ejercer sus derechos de acceso, rectificación, cancelación, oposición, portabilidad y limitación del tratamiento contactando a <a href="mailto:contact@jambol.co" className="underline hover:text-[#FFC72C] transition-colors">contact@jambol.co</a>. Consulta también nuestra <Link to="/politica-cookies" className="underline hover:text-[#FFC72C] transition-colors">Política de Cookies</Link> para conocer cómo gestionamos el consentimiento de cookies y tecnologías similares.</p>

      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">7. Publicidad y monetización</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">8. Propiedad intelectual</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">9. Limitación de responsabilidad</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">10. Uso de servicios de terceros</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">11. Modificaciones de los términos</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">12. Legislación y jurisdicción aplicable</h2>
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">13. Servicios premium y pagos</h2>
      <p className="text-sm md:text-base text-muted-foreground">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2 text-foreground">13.1. Proceso de pago</h3>
      <ul className="list-disc pl-6 text-sm md:text-base text-muted-foreground space-y-1">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2 text-foreground">13.2. Códigos de descuento</h3>
      <ul className="list-disc pl-6 text-sm md:text-base text-muted-foreground space-y-1">
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2 text-foreground">13.3. Política de reembolsos</h3>
      <ul className="list-disc pl-6 text-sm md:text-base text-muted-foreground space-y-1">
        ...
        <li>Para solicitar un reembolso, debes contactar a <a href="mailto:contact@jambol.co" className="underline hover:text-[#FFC72C] transition-colors">contact@jambol.co</a> indicando tu solicitud de reembolso y el identificador de transacción.</li>
      ...
      <h3 className="text-lg font-semibold mt-4 mb-2 text-foreground">13.4. Duración y renovación</h3>
      <ul className="list-disc pl-6 text-sm md:text-base text-muted-foreground space-y-1">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2 text-foreground">14. Aceptación</h2>
